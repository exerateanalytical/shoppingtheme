...
.breadcrumb{display:flex;align-items:center;justify-content:center;gap:0.5rem;font-family:'Space Grotesk',sans-serif;font-size:0.78rem;color:var(--text-light);margin-bottom:1rem}
.breadcrumb a{color:var(--teal);text-decoration:none}
.page-hero h1{font-family:'Cormorant Garamond',serif;font-size:clamp(2rem,5vw,3.2rem);font-weight:600;color:#fff;margin-bottom:0.5rem}
.page-hero p{color:rgba(255,255,255,0.55);font-size:0.95rem;max-width:560px;margin:0 auto}
...
.cat-pill{background:#fff;border:1px solid var(--pearl-dark);border-radius:50px;padding:0.5rem 1.25rem;font-family:'Space Grotesk',sans-serif;font-size:0.8rem;font-weight:600;color:var(--text-mid);cursor:pointer;transition:all .2s}
...
.post-cat{display:inline-flex;align-items:center;gap:0.3rem;font-family:'Space Grotesk',sans-serif;font-size:0.68rem;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;color:var(--teal-dark);margin-bottom:0.75rem;width:fit-content;background:rgba(0,198,179,0.1);padding:3px 10px;border-radius:50px}
.featured-body h2{font-family:'Cormorant Garamond',serif;font-size:1.9rem;font-weight:600;line-height:1.2;margin-bottom:0.75rem}
.featured-body p{font-size:0.92rem;color:var(--text-mid);margin-bottom:1.25rem}
.post-meta{display:flex;align-items:center;gap:1rem;font-family:'Space Grotesk',sans-serif;font-size:0.78rem;color:var(--text-light)}
.post-meta span{display:flex;align-items:center;gap:0.3rem}
.read-tag{display:inline-flex;align-items:center;gap:0.4rem;font-family:'Space Grotesk',sans-serif;font-size:0.82rem;font-weight:600;color:var(--teal-dark);margin-top:1.25rem}
/* GRID */
...
.blog-card-body h3{font-family:'Cormorant Garamond',serif;font-size:1.3rem;font-weight:600;line-height:1.25;margin:0.5rem 0}
.blog-card-body p{font-size:0.85rem;color:var(--text-mid);margin-bottom:1rem;flex:1}
/* NEWSLETTER */
...
.newsletter h2{font-family:'Cormorant Garamond',serif;font-size:2rem;font-weight:600;color:#fff;margin-bottom:0.5rem}
.newsletter p{color:rgba(255,255,255,0.6);font-size:0.9rem;margin-bottom:1.5rem}
.newsletter-form{display:flex;gap:0.75rem;max-width:480px;margin:0 auto}
.newsletter-form input{flex:1;border:none;border-radius:8px;padding:0.85rem 1.25rem;font-family:'Inter',sans-serif;font-size:0.9rem;outline:none}
.newsletter-form button{background:var(--teal);color:var(--navy);border:none;border-radius:8px;padding:0.85rem 1.75rem;font-family:'Space Grotesk',sans-serif;font-size:0.85rem;font-weight:700;cursor:pointer;white-space:nowrap;transition:all .2s}
...
.page-btn{width:40px;height:40px;border-radius:8px;border:1px solid var(--pearl-dark);background:#fff;font-family:'Space Grotesk',sans-serif;font-weight:600;font-size:0.85rem;color:var(--text-mid);cursor:pointer;display:flex;align-items:center;justify-content:center;transition:all .2s}
...
@media(max-width:900px){.featured-post{grid-template-columns:1fr}.featured-img{min-height:220px}.blog-grid{grid-template-columns:1fr 1fr}.footer-grid{grid-template-columns:1fr 1fr}}
@media(max-width:640px){.nav-links{display:none}.nav-hamburger{display:flex}.blog-grid{grid-template-columns:1fr}.newsletter-form{flex-direction:column}.footer-grid{grid-template-columns:1fr}.featured-body{padding:1.5rem}}
</style>
<?php
}, 20 );
get_header( 'alluvia' );
...
<footer>
  <div class="footer-inner">
    ...
    <div class="footer-bottom">
      ...
      <div class="footer-legal"><a href="<?php echo esc_url(home_url('/terms-conditions/')); ?>">Terms</a><a href="<?php echo esc_url(home_url('/privacy-policy/')); ?>">Privacy</a><a href="<?php echo esc_url(home_url('/shipping-policy/')); ?>">Shipping</a><a href="<?php echo esc_url(home_url('/disclaimer/')); ?>">Disclaimer</a></div>
    </div>
  </div>
</footer>
<script>
