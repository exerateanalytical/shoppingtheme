...
:root{
  ...
  --gold:#c8a96e;--pearl:#f4f2ee;--pearl-dark:#e8e4dc;--white:#fff;
...
.icon-xl{width:36px;height:36px;stroke-width:1.4;flex-shrink:0}

/* NAV */
.alluvia-nav{position:fixed;top:0;left:0;right:0;z-index:1000;background:rgba(13,27,42,.97);backdrop-filter:blur(20px);padding:14px 0;box-shadow:0 2px 30px rgba(0,0,0,.2)}
...
.nav-cta{color:var(--navy)!important;background:var(--teal);padding:9px 22px;border-radius:100px;font-weight:600!important}
...
.mobile-overlay{position:fixed;inset:0;z-index:999;background:var(--navy);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:40px;opacity:0;pointer-events:none;transition:opacity .35s}
.mobile-overlay.open{opacity:1;pointer-events:all}
.mobile-overlay a{font-family:var(--font-display);font-size:40px;font-weight:300;color:var(--white);text-decoration:none;transition:color .25s}
...
.page-hero::before{content:'';position:absolute;inset:0;background:radial-gradient(ellipse 80% 60% at 50% 50%,rgba(0,198,179,.08) 0%,transparent 65%),radial-gradient(ellipse 40% 40% at 20% 80%,rgba(200,169,110,.06) 0%,transparent 50%)}
.page-hero-inner{position:relative;z-index:2;max-width:800px;margin:0 auto;padding:0 40px}
.breadcrumb{display:flex;align-items:center;gap:8px;justify-content:center;font-family:var(--font-ui);font-size:12px;font-weight:500;letter-spacing:.08em;color:rgba(255,255,255,.35);text-transform:uppercase;margin-bottom:28px}
.breadcrumb a{color:rgba(255,255,255,.35);text-decoration:none;transition:color .25s}
.breadcrumb a:hover{color:var(--teal)}
.breadcrumb-sep{color:rgba(255,255,255,.2)}
.page-hero-label{display:inline-flex;align-items:center;gap:8px;background:rgba(0,198,179,.1);border:1px solid rgba(0,198,179,.25);border-radius:100px;padding:7px 16px;margin-bottom:24px;font-family:var(--font-ui);font-size:11px;font-weight:600;letter-spacing:.15em;text-transform:uppercase;color:var(--teal)}
...
.page-hero-desc{font-size:18px;font-weight:300;line-height:1.8;color:rgba(255,255,255,.6);max-width:600px;margin:0 auto}
...
.section-desc{font-size:16px;font-weight:300;line-height:1.85;color:var(--text-mid)}
.container{max-width:1280px;margin:0 auto;padding:0 40px}
.btn-primary{display:inline-flex;align-items:center;gap:10px;background:var(--teal);color:var(--navy);font-family:var(--font-ui);font-size:14px;font-weight:700;letter-spacing:.04em;padding:14px 30px;border-radius:100px;text-decoration:none;transition:var(--transition);border:none;cursor:pointer}
.btn-primary:hover{background:var(--teal-dark);transform:translateY(-3px);box-shadow:0 12px 40px rgba(0,198,179,.4)}
.btn-outline{display:inline-flex;align-items:center;gap:10px;background:transparent;color:var(--navy);font-family:var(--font-ui);font-size:14px;font-weight:600;padding:14px 30px;border-radius:100px;text-decoration:none;border:2px solid var(--navy);transition:var(--transition)}
...
.mv-card::before{content:'';position:absolute;top:-60px;right:-60px;width:200px;height:200px;border-radius:50%;background:rgba(0,198,179,.06)}
...
.mv-card:first-child .mv-icon{background:rgba(0,198,179,.12);border:1px solid rgba(0,198,179,.2);color:var(--teal)}
.mv-card:last-child .mv-icon{background:rgba(200,169,110,.12);border:1px solid rgba(200,169,110,.2);color:var(--gold)}
.mv-label{font-family:var(--font-ui);font-size:11px;font-weight:700;letter-spacing:.2em;text-transform:uppercase;margin-bottom:16px;position:relative;z-index:1}
...
.mv-text{font-size:15px;font-weight:300;line-height:1.85;position:relative;z-index:1}
.mv-card:first-child .mv-text{color:rgba(255,255,255,.6)}
...
.story-section::before{content:'STORY';position:absolute;font-family:var(--font-display);font-size:clamp(80px,15vw,200px);font-weight:700;color:rgba(13,27,42,.025);top:50%;left:50%;transform:translate(-50%,-50%);white-space:nowrap;pointer-events:none;user-select:none}
...
.timeline-year{font-family:var(--font-ui);font-size:11px;font-weight:700;letter-spacing:.12em;color:var(--teal);text-align:center;white-space:nowrap}
...
.timeline-card:hover{border-color:rgba(0,198,179,.2);box-shadow:var(--shadow-md);transform:translateY(-4px)}
.timeline-card-title{font-family:var(--font-ui);font-size:15px;font-weight:700;color:var(--navy);margin-bottom:8px}
.timeline-card-text{font-size:14px;color:var(--text-mid);line-height:1.7}

/* VALUES */
.values-section{padding:100px 0;background:var(--navy);position:relative;overflow:hidden}
.values-section::before{content:'';position:absolute;inset:0;background:radial-gradient(ellipse 50% 60% at 100% 50%,rgba(0,198,179,.06) 0%,transparent 55%),radial-gradient(ellipse 40% 50% at 0% 30%,rgba(200,169,110,.04) 0%,transparent 50%);pointer-events:none}
.values-header{text-align:center;margin-bottom:72px}
.values-header .section-title{color:var(--white)}
.values-header .section-desc{color:rgba(255,255,255,.5);margin:0 auto;max-width:560px}
...
.value-text{font-size:14px;font-weight:300;color:rgba(255,255,255,.45);line-height:1.7;transition:color .3s}
.value-card:hover .value-text{color:rgba(255,255,255,.65)}
...
.team-card:hover{border-color:rgba(0,198,179,.2);box-shadow:var(--shadow-md);transform:translateY(-6px)}
...
.team-photo-ring{position:absolute;width:120px;height:120px;border-radius:50%;border:1px solid rgba(0,198,179,.2);animation:spin-slow 12s linear infinite}
.team-photo-ring-2{position:absolute;width:80px;height:80px;border-radius:50%;border:1px solid rgba(200,169,110,.15);animation:spin-slow 8s linear infinite reverse}
...
.team-role{font-family:var(--font-ui);font-size:12px;font-weight:500;letter-spacing:.1em;text-transform:uppercase;color:var(--teal);margin-bottom:14px}
...
.commit-icon{width:48px;height:48px;border-radius:12px;background:rgba(0,198,179,.08);border:1px solid rgba(0,198,179,.15);display:flex;align-items:center;justify-content:center;flex-shrink:0;color:var(--teal);transition:var(--transition)}
...
.commit-text-desc{font-size:13px;color:var(--text-mid);line-height:1.7}
...
.commit-circle{width:160px;height:160px;border-radius:50%;border:2px solid rgba(0,198,179,.3);display:flex;align-items:center;justify-content:center;position:relative}
.commit-circle::before{content:'';position:absolute;width:130px;height:130px;border-radius:50%;border:1px solid rgba(200,169,110,.2);animation:spin-slow 16s linear infinite}
.commit-circle::after{content:'';position:absolute;width:100px;height:100px;border-radius:50%;background:rgba(0,198,179,.08)}
.commit-circle svg{position:relative;z-index:2;color:var(--teal)}
.commit-visual-text{font-family:var(--font-ui);font-size:12px;font-weight:600;letter-spacing:.18em;text-transform:uppercase;color:rgba(255,255,255,.4)}
.commit-badge{position:absolute;background:var(--teal);color:var(--navy);border-radius:12px;padding:14px 20px;font-family:var(--font-ui);font-size:12px;font-weight:700}
...
.cta-section::before{content:'';position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);width:700px;height:700px;border-radius:50%;background:radial-gradient(circle,rgba(0,198,179,.08) 0%,transparent 65%);pointer-events:none}
...
.btn-primary-light:hover{background:var(--teal-dark);transform:translateY(-3px);box-shadow:0 12px 40px rgba(0,198,179,.4)}
...
<section class="values-section">
  <div class="container">
    ...
    <div class="values-grid">
      <div class="value-card reveal" style="--val-color:#00c6b3;">
      ...
      <div class="value-card reveal reveal-delay-1" style="--val-color:#c8a96e;">
      ...
      <div class="value-card reveal reveal-delay-2" style="--val-color:#7fb8d4;">
      ...
      <div class="value-card reveal reveal-delay-3" style="--val-color:#e07b54;">
      ...
      <div class="value-card reveal reveal-delay-4" style="--val-color:#9b72cf;">
      ...
      <div class="value-card reveal reveal-delay-5" style="--val-color:#78c9a2;">
