...
.sidebar-user-email{font-size:var(--fs-base);color:rgba(255,255,255,0.70);margin-top:2px}
.sidebar-nav{list-style:none;padding:0.5rem 0}
.sidebar-nav li{}
.sidebar-nav li a{display:flex;align-items:center;gap:0.75rem;padding:0.75rem 1.25rem;font-family:'Space Grotesk',sans-serif;font-size:var(--fs-body);font-weight:500;color:var(--text-mid);text-decoration:none;transition:all .2s;cursor:pointer;border-left:3px solid transparent}
...
.sidebar-logout{display:flex;align-items:center;gap:0.75rem;padding:0.75rem 1.25rem;font-family:'Space Grotesk',sans-serif;font-size:var(--fs-body);font-weight:500;color:var(--coral);cursor:pointer;border:none;background:none;width:100%;transition:background .2s}
...
.stat-label{font-family:'Space Grotesk',sans-serif;font-size:var(--fs-sm);font-weight:600;letter-spacing:0.08em;text-transform:uppercase;color:var(--text-light);margin-top:0.3rem}
...
.btn-sm{background:var(--navy);color:#fff;border:none;border-radius:6px;padding:0.4rem 0.9rem;font-family:'Space Grotesk',sans-serif;font-size:var(--fs-sm);font-weight:600;cursor:pointer;transition:background .2s;letter-spacing:0.04em;display:flex;align-items:center;gap:0.3rem}
...
.orders-table th{font-family:'Space Grotesk',sans-serif;font-size:var(--fs-sm);font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:var(--text-light);padding:0.6rem 0.75rem;text-align:left;border-bottom:1px solid var(--pearl-dark)}
.orders-table td{padding:1rem 0.75rem;border-bottom:1px solid var(--pearl);vertical-align:middle;font-size:var(--fs-base)}
...
.form-group label{font-family:'Space Grotesk',sans-serif;font-size:var(--fs-ui);font-weight:700;letter-spacing:0.06em;text-transform:uppercase;color:var(--text-mid)}
.form-group input,.form-group select{border:1px solid var(--pearl-dark);border-radius:8px;padding:0.65rem 0.9rem;font-family:'Inter',sans-serif;font-size:var(--fs-base);color:var(--text-dark);outline:none;transition:border .2s;background:#fff}
