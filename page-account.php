...
.default-tag{background:rgba(0,198,179,0.12);color:var(--teal-dark);border-radius:50px;padding:2px 8px;font-size:10px;font-weight:700;letter-spacing:0.06em}
...
<div class="account-layout">
  ...
  <div class="account-sidebar">
    ...
    <ul class="sidebar-nav">
      ...
      <li><a href="#" onclick="switchTab('wishlist',this)"><i data-lucide="heart" width="16" height="16"></i> Wishlist <span style="background:rgba(232,117,138,0.15);color:var(--coral);border-radius:50px;padding:1px 6px;font-size:10px;font-weight:700;margin-left:4px">5</span></a></li>
