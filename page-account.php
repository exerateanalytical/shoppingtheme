...
.account-avatar{width:88px;height:88px;border-radius:50%;background:linear-gradient(135deg,var(--teal),var(--teal-dark));display:flex;align-items:center;justify-content:center;font-family:'Cormorant Garamond',serif;font-size:2.2rem;font-weight:600;color:var(--navy);flex-shrink:0;border:4px solid rgba(255,255,255,0.1);margin-bottom:-1px}
.account-hero-info{padding-bottom:1.5rem}
.account-hero-info h1{font-family:'Cormorant Garamond',serif;font-size:2rem;font-weight:600;color:#fff;margin-bottom:0.25rem}
.account-hero-info p{color:rgba(255,255,255,0.5);font-size:0.88rem;display:flex;align-items:center;gap:0.4rem}
.account-hero-info p svg{color:var(--teal)}
.member-badge{display:inline-flex;align-items:center;gap:0.3rem;background:rgba(200,169,110,0.15);border:1px solid rgba(200,169,110,0.3);border-radius:50px;padding:3px 10px;font-family:'Space Grotesk',sans-serif;font-size:0.68rem;font-weight:700;letter-spacing:0.08em;color:var(--gold);text-transform:uppercase;margin-left:0.75rem}
...
.sidebar-user-name{font-family:'Space Grotesk',sans-serif;font-weight:600;font-size:0.9rem;color:#fff}
.sidebar-user-email{font-size:0.75rem;color:rgba(255,255,255,0.45);margin-top:2px}
.sidebar-nav{list-style:none;padding:0.5rem 0}
.sidebar-nav li{}
.sidebar-nav li a{display:flex;align-items:center;gap:0.75rem;padding:0.75rem 1.25rem;font-family:'Space Grotesk',sans-serif;font-size:0.82rem;font-weight:500;color:var(--text-mid);text-decoration:none;transition:all .2s;cursor:pointer;border-left:3px solid transparent}
.sidebar-nav li a:hover{background:var(--pearl);color:var(--teal);border-left-color:rgba(0,198,179,0.4)}
.sidebar-nav li a.active{background:rgba(0,198,179,0.06);color:var(--teal-dark);border-left-color:var(--teal);font-weight:600}
.sidebar-nav li a svg{flex-shrink:0}
.sidebar-divider{border:none;border-top:1px solid var(--pearl-dark);margin:0.5rem 0}
.sidebar-logout{display:flex;align-items:center;gap:0.75rem;padding:0.75rem 1.25rem;font-family:'Space Grotesk',sans-serif;font-size:0.82rem;font-weight:500;color:var(--coral);cursor:pointer;border:none;background:none;width:100%;transition:background .2s}
.sidebar-logout:hover{background:rgba(232,117,138,0.06)}
...
.stat-icon.teal-bg{background:rgba(0,198,179,0.1);color:var(--teal)}
.stat-icon.gold-bg{background:rgba(200,169,110,0.1);color:var(--gold)}
.stat-icon.coral-bg{background:rgba(232,117,138,0.1);color:var(--coral)}
.stat-icon.mint-bg{background:rgba(120,201,162,0.1);color:var(--mint)}
.stat-num{font-family:'Cormorant Garamond',serif;font-size:2rem;font-weight:700;color:var(--text-dark);line-height:1}
.stat-label{font-family:'Space Grotesk',sans-serif;font-size:0.72rem;font-weight:600;letter-spacing:0.08em;text-transform:uppercase;color:var(--text-light);margin-top:0.3rem}
...
.panel-card-header h3{font-family:'Cormorant Garamond',serif;font-size:1.2rem;font-weight:600;display:flex;align-items:center;gap:0.5rem}
.panel-card-header h3 svg{color:var(--teal)}
.btn-sm{background:var(--navy);color:#fff;border:none;border-radius:6px;padding:0.4rem 0.9rem;font-family:'Space Grotesk',sans-serif;font-size:0.75rem;font-weight:600;cursor:pointer;transition:background .2s;letter-spacing:0.04em;display:flex;align-items:center;gap:0.3rem}
...
.orders-table th{font-family:'Space Grotesk',sans-serif;font-size:0.68rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:var(--text-light);padding:0.6rem 0.75rem;text-align:left;border-bottom:1px solid var(--pearl-dark)}
...
.order-id{font-family:'Space Grotesk',sans-serif;font-weight:700;font-size:0.82rem;color:var(--teal-dark)}
.order-date{color:var(--text-light);font-size:0.8rem}
.order-items-list{font-size:0.82rem;color:var(--text-mid)}
.status-badge{display:inline-flex;align-items:center;gap:0.3rem;font-family:'Space Grotesk',sans-serif;font-size:0.68rem;font-weight:700;letter-spacing:0.06em;padding:3px 10px;border-radius:50px;text-transform:uppercase}
.status-delivered{background:rgba(120,201,162,0.15);color:#2d8a5f}
.status-processing{background:rgba(0,198,179,0.12);color:var(--teal-dark)}
.status-shipped{background:rgba(127,184,212,0.15);color:#2d6e8a}
...
.wish-name{font-family:'Space Grotesk',sans-serif;font-weight:600;font-size:0.82rem;margin-bottom:0.25rem}
.wish-price{font-family:'Space Grotesk',sans-serif;font-weight:700;font-size:0.88rem;color:var(--teal-dark)}
.wish-add{width:100%;background:var(--navy);color:#fff;border:none;border-radius:6px;padding:0.45rem;font-family:'Space Grotesk',sans-serif;font-size:0.72rem;font-weight:600;cursor:pointer;margin-top:0.6rem;transition:all .2s;display:flex;align-items:center;justify-content:center;gap:0.3rem}
...
.form-group label{font-family:'Space Grotesk',sans-serif;font-size:0.72rem;font-weight:700;letter-spacing:0.06em;text-transform:uppercase;color:var(--text-mid)}
.form-group input,.form-group select{border:1px solid var(--pearl-dark);border-radius:8px;padding:0.65rem 0.9rem;font-family:'Inter',sans-serif;font-size:0.88rem;color:var(--text-dark);outline:none;transition:border .2s;background:#fff}
.form-group input:focus,.form-group select:focus{border-color:var(--teal)}
.btn-save{background:linear-gradient(135deg,var(--teal),var(--teal-dark));color:var(--navy);border:none;border-radius:8px;padding:0.7rem 2rem;font-family:'Space Grotesk',sans-serif;font-size:0.85rem;font-weight:700;cursor:pointer;transition:all .3s;display:flex;align-items:center;gap:0.4rem;letter-spacing:0.04em}
.btn-save:hover{transform:translateY(-1px);box-shadow:0 6px 18px rgba(0,198,179,0.3)}
...
.addr-card.default{border-color:var(--teal);background:rgba(0,198,179,0.03)}
.addr-card-type{font-family:'Space Grotesk',sans-serif;font-size:0.7rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:var(--text-light);margin-bottom:0.5rem;display:flex;align-items:center;gap:0.4rem}
.addr-card-type svg{color:var(--teal)}
.default-tag{background:rgba(0,198,179,0.12);color:var(--teal-dark);border-radius:50px;padding:2px 8px;font-size:0.62rem;font-weight:700;letter-spacing:0.06em}
.addr-card h4{font-family:'Space Grotesk',sans-serif;font-weight:600;font-size:0.88rem;margin-bottom:0.3rem}
.addr-card p{font-size:0.82rem;color:var(--text-mid);line-height:1.6}
...
.security-title{font-family:'Space Grotesk',sans-serif;font-weight:600;font-size:0.88rem}
.security-sub{font-size:0.78rem;color:var(--text-light);margin-top:1px}
.security-status{display:flex;align-items:center;gap:0.4rem;font-family:'Space Grotesk',sans-serif;font-size:0.72rem;font-weight:600}
...
@media(max-width:640px){.nav-links{display:none}.nav-hamburger{display:flex}.stat-cards{grid-template-columns:1fr 1fr}.wishlist-grid{grid-template-columns:1fr}.profile-grid{grid-template-columns:1fr}.footer-grid{grid-template-columns:1fr}.account-hero-inner{flex-direction:column;align-items:flex-start}.orders-table{font-size:0.78rem}}
</style>
<?php
}, 20 );
get_header( 'alluvia' );
...
<div class="account-layout">
  ...
  <div class="account-sidebar">
    ...
    <ul class="sidebar-nav">
      ...
      <li><a href="#" onclick="switchTab('wishlist',this)"><i data-lucide="heart" width="16" height="16"></i> Wishlist <span style="background:rgba(232,117,138,0.15);color:var(--coral);border-radius:50px;padding:1px 6px;font-size:0.65rem;font-weight:700;margin-left:4px">5</span></a></li>
      ...
      <div class="panel-card">
        ...
        <div class="panel-card-body">
          <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:1rem;flex-wrap:wrap;gap:1rem">
            <div>
              <div style="font-family:'Cormorant Garamond',serif;font-size:2.5rem;font-weight:700;line-height:1">920 <span style="font-size:1rem;color:var(--text-light)">points</span></div>
              <div style="font-family:'Space Grotesk',sans-serif;font-size:0.75rem;color:var(--text-light);margin-top:0.25rem">80 points until Gold tier</div>
            </div>
            <div style="text-align:right">
              <div style="font-family:'Space Grotesk',sans-serif;font-size:0.72rem;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:var(--gold)">Pro Member</div>
              <div style="font-size:0.78rem;color:var(--text-light)">5% discount on all orders</div>
            </div>
          </div>
          ...
          <div style="display:flex;justify-content:space-between;font-family:'Space Grotesk',sans-serif;font-size:0.7rem;color:var(--text-light);margin-top:0.4rem">
    ...
    <div class="tab-panel" id="panel-orders">
      <div class="panel-card">
        <div class="panel-card-header">
          ...
          <span style="font-family:'Space Grotesk',sans-serif;font-size:0.78rem;color:var(--text-light)">12 orders total</span>
        </div>
          ...
          <table class="orders-table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>Semaglutide ×1</td>
                <td><span class="status-badge status-shipped" style="background:rgba(127,184,212,0.15);color:#2d6e8a">Shipped</span></td>
      ...
      <div class="panel-card">
        ...
        <div class="panel-card-body">
          <div class="wishlist-grid">
            <div class="wish-card">
              <div class="wish-thumb" style="background:rgba(0,198,179,0.1)"><i data-lucide="activity" width="28" height="28" style="color:var(--teal)"></i></div>
            ...
            <div class="wish-card">
              <div class="wish-thumb" style="background:rgba(155,114,207,0.1)"><i data-lucide="trending-down" width="28" height="28" style="color:var(--purple)"></i></div>
            ...
            <div class="wish-card">
              <div class="wish-thumb" style="background:rgba(127,184,212,0.1)"><i data-lucide="dna" width="28" height="28" style="color:var(--sky)"></i></div>
            ...
            <div class="wish-card">
              <div class="wish-thumb" style="background:rgba(120,201,162,0.1)"><i data-lucide="feather" width="28" height="28" style="color:var(--mint)"></i></div>
            ...
            <div class="wish-card">
              <div class="wish-thumb" style="background:rgba(224,123,84,0.1)"><i data-lucide="dumbbell" width="28" height="28" style="color:var(--orange)"></i></div>
...
function showToast(msg) {
  ...
  Object.assign(t.style, {
    ...
    background:'#00c6b3',color:'#0d1b2a',padding:'0.75rem 1.5rem',borderRadius:'50px',
