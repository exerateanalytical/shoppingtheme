...
.ship-opt:hover{border-color:var(--teal);background:rgba(0,198,179,0.03)}
...
/* SUCCESS OVERLAY */
.success-overlay{display:none;position:fixed;inset:0;background:rgba(13,27,42,0.92);z-index:2000;align-items:center;justify-content:center}
    ...
    <div class="panel-body">
      ...
      <div class="tab-content" id="tab3">
        ...
        <div class="review-items">
          ...
          <div class="review-item">
            <div class="review-thumb" style="background:rgba(232,117,138,0.1)"><i data-lucide="sparkles" width="22" height="22" style="color:var(--coral)"></i></div>
            <div>
          ...
          <div class="review-item">
            <div class="review-thumb" style="background:rgba(200,169,110,0.1)"><i data-lucide="zap" width="22" height="22" style="color:var(--gold)"></i></div>
            <div>
