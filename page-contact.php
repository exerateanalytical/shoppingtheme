...
<style>
    ...
    .page-hero::before {
      ...
      background: radial-gradient(circle, rgba(14,175,159, 0.07) 0%, transparent 70%);
      border-radius: 50%;
      pointer-events: none;
    }
    ...
    .page-hero::after {
      ...
      background: radial-gradient(circle, rgba(138,96,193, 0.06) 0%, transparent 70%);
      border-radius: 50%;
      pointer-events: none;
    }
    ...
    .info-card:hover {
      ...
      box-shadow: 0 16px 40px rgba(10,26,39, 0.09);
    }

    .info-card-icon {
      width: 56px;
      height: 56px;
      background: rgba(14,175,159, 0.1);
      border-radius: 50%;
      display: flex;
      align-items: center;
      justify-content: center;
    ...
    .contact-form-card {
      ...
      border-radius: 20px;
      padding: 48px;
      box-shadow: 0 4px 28px rgba(10,26,39, 0.06);
    }
    ...
    .form-group textarea:focus {
      ...
      box-shadow: 0 0 0 3px rgba(14,175,159, 0.12);
      background: var(--white);
    }
    ...
    .success-icon-wrap {
      width: 76px;
      height: 76px;
      background: rgba(14,175,159, 0.12);
      border-radius: 50%;
      display: flex;
      align-items: center;
      justify-content: center;
    ...
    .sidebar-card {
      ...
      border-radius: 16px;
      padding: 28px;
      box-shadow: 0 4px 24px rgba(10,26,39, 0.06);
    }
    ...
    .btn-ghost-white {
      ...
      color: var(--navy);
      border: 2px solid rgba(10,26,39, 0.4);
      border-radius: 50px;
      padding: 9px 22px;
      cursor: pointer;
      text-decoration: none;
    ...
    .faq-item.open { border-color: rgba(14,175,159, 0.3); }
    ...
    .map-placeholder::before {
      ...
      position: absolute;
      inset: 0;
      background: radial-gradient(ellipse at 50% 50%, rgba(14,175,159, 0.11) 0%, transparent 65%);
      pointer-events: none;
    }
    ...
    .map-icon-wrap {
      width: 64px;
      height: 64px;
      background: rgba(14,175,159, 0.14);
      border-radius: 50%;
      display: flex;
      align-items: center;
      justify-content: center;
