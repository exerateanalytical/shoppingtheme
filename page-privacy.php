...
:root{--navy:#0d1b2a;--navy-soft:#1e3050;--teal:#00c6b3;--teal-dark:#009e8e;--gold:#c8a96e;--pearl:#f4f2ee;--pearl-dark:#e8e4dc;--text-dark:#0d1b2a;--text-mid:#4a5568;--text-light:#8899aa;--radius:12px}
...
.policy-section h3{font-family:'Space Grotesk',sans-serif;font-size:0.9rem;font-weight:700;color:var(--text-dark);margin:1.25rem 0 0.5rem}
.policy-list{list-style:none;display:flex;flex-direction:column;gap:0.5rem;margin-bottom:1rem}
.policy-list li{display:flex;align-items:flex-start;gap:0.6rem;font-size:0.88rem;color:var(--text-mid)}.policy-list li svg{color:var(--teal);flex-shrink:0;margin-top:3px}
.policy-section a{color:var(--teal-dark);text-decoration:none}.policy-section a:hover{text-decoration:underline}
.highlight-box{background:rgba(0,198,179,0.05);border:1px solid rgba(0,198,179,0.2);border-radius:8px;padding:1rem 1.25rem;margin:1rem 0;font-size:0.88rem;color:var(--text-mid)}.highlight-box strong{color:var(--text-dark)}
