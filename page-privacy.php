...
.highlight-box{background:rgba(0,198,179,0.05);border:1px solid rgba(0,198,179,0.2);border-radius:8px;padding:1rem 1.25rem;margin:1rem 0;font-size:14px;color:var(--text-mid)}.highlight-box strong{color:var(--text-dark)}
