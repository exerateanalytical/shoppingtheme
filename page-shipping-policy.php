...
.cold-stat-num{font-family:'Cormorant Garamond',serif;font-size:2.2rem;font-weight:700;color:#fff;line-height:1}
.cold-stat-label{font-family:'Space Grotesk',sans-serif;font-size:0.75rem;font-weight:600;letter-spacing:0.08em;text-transform:uppercase;color:var(--text-light);margin-top:0.3rem}
...
.section-header h2{font-family:'Cormorant Garamond',serif;font-size:1.5rem;font-weight:600}

/* SHIPPING TABLE */
.ship-table{width:100%;border-collapse:collapse;font-size:0.88rem}
.ship-table th{background:var(--navy);color:rgba(255,255,255,0.7);font-family:'Space Grotesk',sans-serif;font-size:0.72rem;font-weight:600;letter-spacing:0.08em;text-transform:uppercase;padding:0.75rem 1rem;text-align:left}
...
.method-name{font-family:'Space Grotesk',sans-serif;font-weight:600;font-size:0.88rem}
.method-sub{font-size:0.76rem;color:var(--text-light);margin-top:2px}
...
.ship-badge-sm{font-family:'Space Grotesk',sans-serif;font-size:0.62rem;font-weight:700;padding:2px 7px;border-radius:50px;letter-spacing:0.06em}
.badge-rec{background:rgba(127,184,212,0.15);color:#2d6e8a}
.badge-fast{background:rgba(224,123,84,0.15);color:#a04020}

/* INFO CARD */
.info-card{border-left:3px solid var(--teal);background:rgba(0,198,179,0.05);border-radius:0 8px 8px 0;padding:1rem 1.25rem;margin-bottom:1rem;font-size:0.88rem;color:var(--text-mid)}
.info-card strong{color:var(--text-dark)}
.warn-card{border-left:3px solid var(--gold);background:rgba(200,169,110,0.07);border-radius:0 8px 8px 0;padding:1rem 1.25rem;margin-bottom:1rem;font-size:0.88rem;color:var(--text-mid)}
...
.faq-q{padding:1rem 1.25rem;display:flex;align-items:center;justify-content:space-between;cursor:pointer;font-family:'Space Grotesk',sans-serif;font-weight:600;font-size:0.9rem;background:#fff;transition:background .2s;user-select:none}
...
.pkg-card h4{font-family:'Space Grotesk',sans-serif;font-size:0.82rem;font-weight:700;margin-bottom:0.3rem}
.pkg-card p{font-size:0.78rem;color:var(--text-light)}
...
@media(max-width:900px){.cold-chain-inner{grid-template-columns:1fr 1fr}.footer-grid{grid-template-columns:1fr 1fr}.pkg-grid{grid-template-columns:1fr 1fr}}
@media(max-width:640px){.cold-chain-inner{grid-template-columns:1fr}.nav-links{display:none}.nav-hamburger{display:flex}.pkg-grid{grid-template-columns:1fr}.footer-grid{grid-template-columns:1fr}}
</style>
<?php
}, 20 );
get_header( 'alluvia' );
...
<nav class="alluvia-nav" id="nav">
  ...
  <div class="nav-right">
    <a href="<?php echo esc_url(alluvia_cart_url()); ?>" class="nav-cart-btn">
      <i data-lucide="shopping-bag" width="16" height="16"></i> Cart <span class="cart-count">4</span>
    </a>
    ...
    <table class="ship-table">
      ...
      <tbody>
        <tr>
          ...
          <td><span style="color:var(--text-light);font-size:0.8rem">Not included</span></td>
        </tr>
        <tr>
