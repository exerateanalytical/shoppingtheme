...
.nav-cart-btn{position:relative;background:var(--teal);color:var(--navy);border:none;border-radius:8px;padding:0.5rem 1rem;display:flex;align-items:center;gap:0.4rem;font-family:'Space Grotesk',sans-serif;font-size:13px;font-weight:600;cursor:pointer;text-decoration:none}
...
.check-list li{display:flex;align-items:flex-start;gap:0.6rem;font-size:15px;color:var(--text-mid)}
...
.faq-q{padding:1rem 1.25rem;display:flex;align-items:center;justify-content:space-between;cursor:pointer;font-family:'Space Grotesk',sans-serif;font-weight:600;font-size:15px;background:#fff;transition:background .2s;user-select:none}
...
.pkg-card h4{font-family:'Space Grotesk',sans-serif;font-size:13px;font-weight:700;margin-bottom:0.3rem}
.pkg-card p{font-size:13px;color:var(--text-light)}
...
.cold-chain-inner{grid-template-columns:1fr}.nav-links{display:none}.nav-hamburger{display:flex}.pkg-grid{grid-template-columns:1fr}.footer-grid{grid-template-columns:1fr}}
