...
.disclaimer-text{color:#fff;font-size:0.88rem;line-height:1.6}
.disclaimer-text strong{font-family:'Space Grotesk',sans-serif;font-size:0.78rem;font-weight:700;letter-spacing:0.08em;text-transform:uppercase;display:block;margin-bottom:0.25rem}
...
.toc-header h3{font-family:'Space Grotesk',sans-serif;font-size:0.78rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:rgba(255,255,255,0.7)}
.toc-list{list-style:none;padding:0.75rem 0}
.toc-list li a{display:flex;align-items:center;gap:0.5rem;padding:0.5rem 1.25rem;font-family:'Space Grotesk',sans-serif;font-size:0.78rem;font-weight:500;color:var(--text-mid);text-decoration:none;transition:all .2s;border-left:2px solid transparent}
.toc-list li a:hover{color:var(--teal);border-left-color:var(--teal);background:rgba(0,198,179,0.04)}
.toc-list li a.active{color:var(--teal-dark);border-left-color:var(--teal);background:rgba(0,198,179,0.06);font-weight:600}
...
.section-num{font-family:'Space Grotesk',sans-serif;font-size:0.68rem;font-weight:700;letter-spacing:0.12em;text-transform:uppercase;color:var(--teal);margin-bottom:0.25rem}
.terms-section h2{font-family:'Cormorant Garamond',serif;font-size:1.6rem;font-weight:600;margin-bottom:1.25rem;padding-bottom:0.75rem;border-bottom:1px solid var(--pearl-dark)}
.terms-section p{font-size:0.9rem;color:var(--text-mid);line-height:1.8;margin-bottom:1rem}
.terms-section p:last-child{margin-bottom:0}
.terms-section h3{font-family:'Space Grotesk',sans-serif;font-size:0.9rem;font-weight:700;color:var(--text-dark);margin:1.25rem 0 0.5rem}
.terms-list{list-style:none;display:flex;flex-direction:column;gap:0.5rem;margin-bottom:1rem}
.terms-list li{display:flex;align-items:flex-start;gap:0.6rem;font-size:0.88rem;color:var(--text-mid)}
...
.highlight-box{background:rgba(0,198,179,0.05);border:1px solid rgba(0,198,179,0.2);border-radius:8px;padding:1rem 1.25rem;margin:1rem 0;font-size:0.88rem;color:var(--text-mid)}
.warn-box{background:rgba(200,169,110,0.07);border:1px solid rgba(200,169,110,0.25);border-radius:8px;padding:1rem 1.25rem;margin:1rem 0;font-size:0.88rem;color:var(--text-mid)}
...
@media(max-width:640px){.nav-links{display:none}.nav-hamburger{display:flex}.footer-grid{grid-template-columns:1fr}}
</style>
<?php
}, 20 );
get_header( 'alluvia' );
