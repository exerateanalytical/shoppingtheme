...
@media(max-width:780px){.alluvia-shop-wrap{grid-template-columns:1fr}.alluvia-shop-sidebar{position:static}}
</style>';
}, 20 );
...
?>
  <div class="alluvia-shop-wrap">
    <aside class="alluvia-shop-sidebar">
      ...
      <a href="<?php echo esc_url($shop_base); ?>" style="display:flex;align-items:center;justify-content:center;gap:8px;padding:11px;border-radius:8px;border:1.5px solid var(--pearl-dark);font-family:var(--font-ui);font-size:13px;font-weight:600;color:var(--text-mid);text-decoration:none;background:#fff;transition:.2s">
        Reset Filters
      </a>
    </aside>
    <div>
